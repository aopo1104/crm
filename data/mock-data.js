...
function calcClaimLimit(points) {
...
const leadStageMap = { pending_contact: "待接触", contacting: "接触阶段", interacting: "互联阶段", invalid: "已失效" };
const customerStageMap = { not_ordered: "未成交", sample: "样品阶段", closed: "已成交" };
const levelColors = { A: "badge-orange", B: "badge-blue", C: "badge-gray" };
const leadStageColors = { pending_contact: "badge-gray", contacting: "badge-blue", interacting: "badge-purple", invalid: "badge-red" };
const customerStageColors = { not_ordered: "badge-gray", sample: "badge-orange", closed: "badge-green" };
const quoteStatusMap = {
  draft: { label: "草稿", color: "badge-gray" },
  pending_approval: { label: "待审批", color: "badge-yellow" },
  approved: { label: "已审批", color: "badge-green" },
  rejected: { label: "已拒绝", color: "badge-red" },
  sent: { label: "已发送", color: "badge-blue" },
};
const taskStatusMap = {
  draft: { label: "草稿", color: "badge-gray" },
  active: { label: "进行中", color: "badge-blue" },
  completed: { label: "已完成", color: "badge-green" },
};
const opportunityStageMap = {
  initial: "初步接触", requirement: "需求确认", proposal: "方案报价",
  negotiation: "商务谈判", won: "赢单", lost: "输单",
};
const opportunityStageColors = {
  initial: "badge-gray", requirement: "badge-blue", proposal: "badge-purple",
  negotiation: "badge-yellow", won: "badge-green", lost: "badge-red",
};
const followUpTypeMap = {
  visit: "线下拜访", meeting: "会议", email: "邮件联系", social: "社媒联系", whatsapp: "WhatsApp联系",
};
